...
function showMessage() {
	if type -p notify-send; then
		notify-send -u critical "MemView" "$1"
	else
		echo $1
	fi
}
...
BINARY="$SCRIPTPATH/MemView"


JVMDefaultOptions=""
JVMOptionsFile="$SCRIPTPATH/MemView.l4j.ini"
...
$JAVA $JVMDefaultOptions -cp $JVMClassPath main.controllers.HelloApplication $@
exit 0
